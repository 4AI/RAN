...
# rannet
# base_dir = rannet-base-en-uncased-model'
...
# data path
train_path = 'data/arxiv-clf/train.jsonl'
valid_path = 'data/arxiv-clf/test.jsonl'
test_path = 'data/arxiv-clf/test.jsonl'
save_model_path = 'ckpts/best_arxiv_model.weights'
...
# output = L.Dense(256, activation='swish', kernel_initializer=rannet.initializer)(output)  # 128
...
if __name__ == '__main__':
    ...
    model.compile(
        ...
        optimizer=keras.optimizers.Adam(5e-5),  # 5.5e-5
        metrics=['accuracy'],
    )
    model.fit(
