...
# data path
train_path = 'data/agnews/train.jsonl'
valid_path = 'data/agnews/test.jsonl'
test_path = 'data/agnews/test.jsonl'
save_model_path = 'ckpts/best_agnews_model.weights'
...
valid_data = DataGenerator.load_data(test_path, label2idx)
...
# output = L.Dense(768, activation='tanh', kernel_initializer=rannet.initializer)(output)  # 512
...
if __name__ == '__main__':
    ...
    model.compile(
        ...
        optimizer=keras.optimizers.Adam(5e-5),  # 1e-5
        metrics=['accuracy'],
    )
    model.fit(
